        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/analytics" className="text-green-600 font-semibold">
                Analytics
              </Link>
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              ...
              {/* Quick Stats */}
              <div className="card p-6 bg-gradient-to-br from-green-600 to-teal-600 text-white">
                <h3 className="text-xl font-bold mb-6">This Week</h3>
                <div className="space-y-4">
                  <div>
                    <div className="text-3xl font-bold">23</div>
                    <div className="text-green-100 text-sm">New Posts</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold">1.2K</div>
                    <div className="text-green-100 text-sm">New Followers</div>
                  </div>
                  <div>
