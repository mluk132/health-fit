        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/feed" className="text-gray-700 hover:text-green-600 transition-colors">
                Feed
              </Link>
              <Link href="/create" className="text-green-600 font-semibold">
                Create
              </Link>
              <Link href="/analytics" className="text-gray-700 hover:text-green-600 transition-colors">
                Analytics
              </Link>
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-600 to-teal-600 cursor-pointer"></div>
            </div>
          </div>
        </div>
      </nav>
              ...
              <div className="card p-6">
                ...
                <div className="flex gap-2 mb-3 flex-wrap">
                  {tags.map((tag) => (
                    <span 
                      key={tag}
                      className="px-3 py-1 bg-green-100 text-indigo-700 rounded-full text-sm font-medium flex items-center gap-2"
                    >
                      #{tag}
                      <button 
